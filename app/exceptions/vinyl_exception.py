from app.exceptions.base_exception import NotFoundError, AlreadyExistsError, ForbiddenError, PendingError, Registered
...
class VinylPending(PendingError):
    def __init__(self, vinyl_id: int, user_id: int):
        super().__init__("Vinyl", vinyl_id, user_id)

class VinylCreated(Registered):
    def __init__(self, vinyl_id: int, user_id: int):
        super().__init__("Vinyl", vinyl_id, user_id)